    ...
    fn tasks() -> Vec<BenchmarkTask> {
        ...
        all.extend(vec![
            ...
            BenchmarkTask {
                ...
                validation_type: "code".into(), reference: None, language: Some("python".into()),
            },
            // PY-002: Leap year
            BenchmarkTask {
                id: "PY-002".into(),
        ...
        all.extend(vec![
            BenchmarkTask {
                ...
                forbidden_elements: vec![],
                validation_type: "code".into(), reference: None, language: Some("go".into()),
            },
            BenchmarkTask {
                id: "GO-002".into(),
        ...
        all.extend(vec![
            BenchmarkTask {
                ...
                forbidden_elements: vec![],
                validation_type: "code".into(), reference: None, language: Some("rust".into()),
            },
            BenchmarkTask {
                id: "RS-002".into(),
        ...
        all.extend(vec![
            BenchmarkTask {
                ...
                forbidden_elements: vec![],
                validation_type: "code".into(), reference: None, language: Some("javascript".into()),
            },
            BenchmarkTask {
                id: "JS-002".into(),
                description: "Two-fer".into(),
        ...
        all.extend(vec![
            BenchmarkTask {
                ...
                forbidden_elements: vec![],
                validation_type: "code".into(), reference: None, language: Some("java".into()),
            },
            BenchmarkTask {
                id: "JV-002".into(),
                description: "Two-fer".into(),
        ...
        all.extend(vec![
            BenchmarkTask {
                ...
                forbidden_elements: vec![],
                validation_type: "code".into(), reference: None, language: Some("cpp".into()),
            },
            BenchmarkTask {
                id: "CP-002".into(),
                description: "Leap year".into(),
