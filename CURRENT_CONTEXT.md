...
| ID | Status | Owner |
|----|--------|-------|
| CONST-0001 | Draft (80%) | Architect |
| DIRECTIVE-0001 | Approved | Architect |
| BOOTSTRAP-0001 | Active | — |
| INDEX-0001 | Active | — |
...
Setup of the full Athenas directory structure, founding documents, ontology, templates, and project state.
...
Approve CONST-0001 (Review → Approved).
